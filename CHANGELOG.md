...
- Various cog options are availabe to make settings of both blocks quicker to apply and provide flexibility for those Mobirise builder users who are not so comfoprtable editing CSS. 
  ...
  - <b>BLOCK 1: MobiGary Configurable Mobirise Bootstrap Menu v3.4.</b><br>
    - NOTE: This bock has an incompatibility with the hamburger menu X not showing correctly when menu is open in hamburger menu in the new bootstrap 5 themes (e.g. 5.3.15 beta with "Mobirise 5" or "GlassM5"). menu still opens but does not show the X as previously. Issue alos is evident in Standard Mobirise menu. issue reported to Mobirise.
