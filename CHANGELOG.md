...
- Various cog options are availabe to make settings of both blocks quicker to apply and provide flexibility for those Mobirise builder users who are not so comfoprtable editing CSS. 
  ...
  - <b>BLOCK 1: MobiGary Configurable Mobirise Bootstrap Menu v3.4.</b><br>
    - NOTE: This bock has an incompatibility with the hamburger menu opening and closing correctly in the new bootstrap 5 themes (e.g. 5.3.15 beta with "Mobirise 5" or "GlassM5"). Do not use the MobiGary Menu with these new bootstrap 5 themes on a live project. Mobirise are currenty investigating how to best use non-bootstrap 5 blocks from M4 themes in the newer bootstrap 5 based themes.
