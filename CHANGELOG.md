...
https://github.com/MobiGary/MobiriseM4blocks/blob/main/assets/images/MobiGaryMenu-overview.jpg
  ...
  - <b>BLOCK 2: "MobiGary Configurable Mobirise Bootstrap Floating Contact Form" for witsec Mailform Extension v12.x - Block v2.0.</b><br> 
    ...
    - Modified CSS settings which handle size and alignement of social icons (if used)r. Using the combination of "Icon Size" and "SEND btn Text Size" setting you can configure how the icons look in relation to the font size. One example shown below:<br> 
